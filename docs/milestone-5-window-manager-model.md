...
Status: **complete** in `crates/sayuki-compositor` — both **5a (canvas/viewport
WM core / mechanism)** and **5b (project session layer / policy)** shipped. 5a
stands alone; 5b builds on it. (Tiling layouts remain deferred per *Deferred*.)
